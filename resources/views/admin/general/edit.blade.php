...
<form action="{{ route('general.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                <input type="text" name='workday' class="form-control {{$errors->first('workday') ? "is-invalid" : "" }} " value="{{old('workday') ? old('workday') : $general->workday}}" id="workday" placeholder="Senin - Sabtu">
                <div class="invalid-feedback">
        ...
        <div class="form-group ml-5">
            <label for="worktime" class="col-sm-2 col-form-label">Work Time</label>
            <div class="col-sm-7">
                <input type="text" name='worktime' class="form-control {{$errors->first('worktime') ? "is-invalid" : "" }} " value="{{old('worktime') ? old('worktime') : $general->worktime}}" id="worktime" placeholder="08.00 - 21.00 WIB">
                <div class="invalid-feedback">
